const questions = [
        {
          "question": "Wilhelm Wundt and his students used a technique known as to study mental states.",
          "options": [
            "behaviorism",
        ...
        {
          "question": "Cognitive psychology is broad, and thus overlaps with many other fields including neuroscience, philosophy, and",
          "options": [
            "botany",
            "astronomy",
            "linguistics",
        ...
        {
          "question": "The analysis of information processing systems is of special interest to psychology.",
          "options": [
            "behavioral",
            "biological",
            "psychoanalytic",
        ...
        {
          "question": "If you think of cognitive processing as a type of information processing, then the brain is the and the cognitive processes themselves are the",
          "options": [
            "response; stimulus",
            "hardware; software",
            "software; hardware",
        ...
        {
          "question": "Gibson's theory of direct perception is in direct opposition to the approach to perception.",
          "options": [
            "connectionist",
            "constructivist",
            "bottom-up",
        ...
        {
          "question": "Prototype matching theory argues that precepts are compared to in memory.",
          "options": [
        ...
        {
          "question": "____ are to visual perception what phonemes are to language, according to Biederman.",
          "options": [
            "templates",
            "distal stimuli",
            "geons",
        ...
        },
        {
          ...
          "options": [
            "an earthquake",
            "a series of airplanes landing",
            "traffic a few miles away",
        ...
        {
          "question": "Noticing a red flower among a field of purple flowers illustrates",
          "options": [
        ...
        {
          "question": "According to Treisman, if you listen to two competing messages simultaneously, you are more likely to pick up information from the second message if that message",
          "options": [
            "relates to the other message",
            "was spoken more slowly",
        ...
        },
        {
          ...
          "options": [
            ...
            "participants are given more practice at reading color names",
      ...
      },
      {
        ...
        "options": [
          ...
          "a physical characteristic of the message, such as its portion",
          "the importance of the message",
          "the number of repetitions of the message"
        ],
        "answer": "a physical characteristic of the message, such as its portion"
      },
      {
        "question": "Our attention has been said to involve a that filters out everything except the information we are attending to.",
        "options": [
          "net",
          "bottleneck",
          "switchboard",
      ...
      {
        "question": "According to theory, we never actually acquire unattended material at all",
        "options": [
          "capacity",
          "bottleneck",
          "schema",
      ...
      },
      {
        ...
        "options": [
          ...
          "cannot switch attention from one task to another",
      ...
      },
      {
        ...
        "options": [
          ...
          "the highest possible level given the amount of background distraction",
      ...
      {
        "question": "Remembering your phone number in sequences such as xxx-xxx-xxxx and your Social Security number in sequences such as xxx-xx-xxxx are examples of",
        "options": [
          "short-term memory",
          "encoding",
          "sensory memory",
      ...
      {
        "question": "The briefest form of memory is memory.",
        "options": [
          "long-term",
          "working",
          "short-term",
      ...
      },
      {
        ...
        "options": [
          "search is both self-terminating and serial",
      ...
      {
        "question": "Some experts describe memory as a , while others believe it is a",
        "options": [
          "checklist; blueprint",
          "secret; journey",
          "structure; process",
      ...
      {
        "question": "One basic physiological mechanism for learning is the rule, which states that if a synapse between two neurons is repeatedly activated at about the same time the postsynaptic neuron fires, the chemistry of the synapse changes.",
        "options": [
          "Baddeley",
          "Hebb",
          "Tulving",
      ...
      {
        "question": "Which of the following would be part of your declarative memory system?",
        "options": [
      ...
      {
        "question": "When we cannot retrieve information from memory, we say that has occurred.",
        "options": [
          "forgetting",
          "a memory trace",
          "sensory decay",
      ...
      },
      {
        ...
        "options": [
          ...
          "neither decay nor interference"
        ],
      ...
      {
        "question": "According to ACT models, memory represents information in if-then production rules.",
        "options": [
          "working",
          "procedural",
          "episodic",
      ...
      {
        "question": "The view of concepts argues that concepts include representations of at least some individual instances and not only abstract summaries.",
        "options": [
          "classical",
          "prototype",
          "schemata",
      ...
      {
        "question": "If 'sandwich' is a basic-level category, then would be a superordinate level.",
        "options": [
          "soup",
          "sub",
          "panini",
      ...
      {
        "question": "In Paivio's study of paired-associate learning, subjects learned four types of word pairs: I. concrete-concrete (for example, book-table) II. concrete-abstract (for example, book-freedom) III. abstract-concrete (for example, freedom-table) IV. abstract-abstract (for example, freedom-honesty) Which of the following accurately portrays participants' recall of the four types of pairs, from highest recall to lowest?",
        "options": [
          "I, III, II, IV",
          "I, II, III, IV",
          "II, III, I, IV",
      ...
      {
        "question": "Some theorists believe that there is a single code for all types of information; this code is known as a representation.",
        "options": [
          "visual",
          "pictorial",
          "verbal",
      ...
      {
        "question": "Kosslyn compared people's verification times for statements like 'Cats have claws' (high association, small visual part of a cat) to 'Cats have heads' (low association, large visual part of a cat). He found that people were:",
        "options": [
      ...
      {
        "question": "Which of the following is/are generally agreed upon as necessary criterion for claiming that a communication system is a language?",
        "options": [
          "regularity",
          "productivity",
          "referentiality",
      ...
      },
      {
        ...
        "options": [
          ...
          "they do not have a formal grammar",
          "they cannot express quite combinations of ideas",
          "they do not have a permanent (written) form"
        ],
        "answer": "they cannot express quite combinations of ideas"
      },
      {
      ...
      {
        "question": "English speakers hear a distinction between 'l' and 'r' sounds; speakers of some Chinese dialects do not hear this distinction. This example illustrates a difference in the aspects of the two languages.",
        "options": [
          "phonetic",
          "phonological",
          "semantic",
      ...
      },
      {
        ...
        "options": [
          ...
          "both expressive aphasia and inability to comprehend written language"
        ],
      ...
      {
        "question": "A(n) problem has a clear goal, a small set of starting information, and rules about how to attain the goal.",
        "options": [
          "classic",
          "laboratory",
          "well-defined",
      ...
      {
        "question": "The string problem often generates when participants do not think to use the screwdriver as a pendulum.",
        "options": [
          "functional fixedness",
          "mental set",
      ...
      {
        "question": "involves appropriate novelty in generating solutions.",
        "options": [
          "Intelligence",
          "Genius",
          "Creativity",
      ...
      {
        "question": "If a person has five letters in his or her name, then she is a Glirple. I can now validly assume that:",
        "options": [
          "Shawn is a Glirple",
      ...
      {
        "question": "is a normative model for integrating different dimensions and goals of a complex decision.",
        "options": [
          "Expected utility",
          "MAUT",
          "Framing",
      ...
      {
        "question": "Expert decision makers may rely on intuition and mental simulation, according to the model.",
        "options": [
      ...
      {
        "question": "Expected utility theory is usually regarded as a model of decision making.",
        "options": [
          "descriptive",
          "prescriptive",
          "normative",
